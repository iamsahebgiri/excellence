  ...
  function (e) {
    e.exports = {
      ar: {
        ...
        accept: "Ù…ÙˆØ§ï¿½?Ù‚",
        manual: "Ø§Ù„Ø¯Ù„ÙŠÙ„",
        insert_math: "Ø¥Ø¯Ø±Ø§Ø¬ ØµÙŠØºØ© Ø±ÙŠØ§Ø¶ÙŠØ© - MathType",
      ...
      ca: {
        ...
        accept: "Acceptar",
        manual: "Manual",
        insert_math: "Inserir fÃ³rmula matemÃ tica - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      cs: {
        ...
        accept: "OK",
        manual: "PÅ™Ã­ruï¿½?ka",
        insert_math: "VloÅ¾it matematickÃ½ vzorec - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      da: {
        ...
        insert_math: "IndsÃ¦t matematisk formel - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      de: {
        ...
        accept: "OK",
        manual: "Handbuch",
        insert_math: "Mathematische Formel einfÃ¼gen - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      es: {
        ...
        accept: "Aceptar",
        manual: "Manual",
        insert_math: "Insertar fÃ³rmula matemÃ¡tica - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      et: {
        ...
        accept: "OK",
        manual: "KÃ¤siraamat",
        insert_math: "Lisa matemaatiline valem â€“ WIRIS",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      eu: {
        ...
        accept: "OK",
        manual: "Manual",
        insert_math: "LiitÃ¤ matemaattinen kaava - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      fr: {
        ...
        accept: "OK",
        manual: "Manuel",
        insert_math: "InsÃ©rer une formule mathÃ©matique - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      he: {
        ...
        accept: "ï¿½?×™×©×•×¨",
        manual: "×ž×“×¨×™×š",
        insert_math: "×”×•×¡×£ × ×•×¡×—×” ×ž×ª×ž×˜×™×ª - MathType",
        insert_chem: "×”×•×¡×¤×ª ×›×ª×™×‘×” ×›×™×ž×™×ª - ChemType",
        minimize: "×ž×–×¢×¨×™",
        maximize: "×ž×¨×‘×™",
        fullscreen: "×ž×¡×š ×ž×œï¿½?",
        exit_fullscreen: "×™×¦×™ï¿½?×” ×ž×ž×¦×‘ ×ž×¡×š ×ž×œï¿½?",
        close: "×¡×’×™×¨×”",
        mathtype: "MathType",
        title_modalwindow: "MathType modal window",
        close_modal_warning:
        ...
        exception_key_nonobject: "Object.keys called on non-object",
        exception_null_or_undefined: " this is null or not defined",
        exception_not_function: " ï¿½?×™× × ×” ×¤×•× ×§×¦×™×”",
        exception_invalid_date_format:
          "×ª×¡×“×™×¨ ×ªï¿½?×¨×™×š ï¿½?×™× ×• ×ª×§×™×Ÿ : ",
        exception_casting: "×œï¿½? × ×™×ª×Ÿ ×œ×”×ž×™×¨ ",
        exception_casting_to: " ×œ ",
      },
      hr: {
        latex: "LaTeX",
        cancel: "PoniÅ¡ti",
        accept: "U redu",
        manual: "Priruï¿½?nik",
        insert_math: "Umetnite matematiï¿½?ku formulu - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      hu: {
        ...
        accept: "OK",
        manual: "KÃ©zikÃ¶nyv",
        insert_math: "Matematikai kÃ©plet beszÃºrÃ¡sa - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      ja: {
        ...
        cancel: "ã‚­ãƒ£ãƒ³ã‚»ãƒ«",
        accept: "OK",
        manual: "ãƒžãƒ‹ãƒ¥ã‚¢ãƒ«",
        insert_math: "æ•°ï¿½?ã‚’æŒ¿å…¥ - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      ko: {
        ...
        accept: "ìŠ¹ï¿½?ï¿½",
        manual: "ì„¤ëª…ì„œ",
        insert_math: "ìˆ˜í•™ ê³µï¿½? ì‚½ìž… - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      pl: {
        ...
        accept: "OK",
        manual: "Instrukcja",
        insert_math: "Wstaw formuÅ‚Ä™ matematycznÄ… - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      ru: {
        ...
        insert_math:
          "Ð’ï¿½?Ñ‚Ð°Ð²Ð¸Ñ‚ÑŒ Ð¼Ð°Ñ‚ÐµÐ¼Ð°Ñ‚Ð¸Ñ‡Ðµï¿½?ÐºÑƒÑŽ Ñ„Ð¾Ñ€Ð¼ÑƒÐ»Ñƒ: WIRIS",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      tr: {
        ...
        accept: "Tamam",
        manual: "KÄ±lavuz",
        insert_math: "Matematik formÃ¼lÃ¼ ekle - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      zh: {
        ...
        accept: "ç¡®å®š",
        manual: "æ‰‹å†Œ",
        insert_math: "ï¿½?ï¿½å…¥æ•°å­¦å…¬ï¿½? - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      el: {
        ...
        insert_math:
          "Î•Î¹ÏƒÎ±Î³Ï‰Î³Î® Î¼Î±Î¸Î·Î¼Î±Ï„Î¹ÎºÎ¿ï¿½? Ï„ï¿½?Ï€Î¿Ï… - MathType",
        insert_chem: "Insert a chemistry formula - ChemType",
        minimize: "Minimize",
        maximize: "Maximize",
        fullscreen: "Full-screen",
      ...
      return (
        (function (e, t, i) {
          ...
          },
          {
            ...
            get: function () {
              return {
                ltElement: "Â«moÂ»<Â«/moÂ»",
                gtElement: "Â«moÂ»>Â«/moÂ»",
                ampElement: "Â«moÂ»&Â«/moÂ»",
              };
            },
          },
          {
            ...
            get: function () {
              return {
                ltElement: "Â«moÂ»Â§lt;Â«/moÂ»",
                gtElement: "Â«moÂ»Â§gt;Â«/moÂ»",
                ampElement: "Â«moÂ»Â§amp;Â«/moÂ»",
              };
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              var t = "value=",
                ...
                a = e.indexOf(o, r),
                s = e.substring(r, a),
                l = s.split("Â«").join("Â§lt;");
              return (
                (l = (l = (l = l.split("Â»").join("Â§gt;"))
                  .split("&")
                  .join("Â§"))
                  .split("Â¨")
                  .join("Â§quot;")),
        ...
        })(e, [
          {
            ...
            value: function () {
              ...
              if (
                ...
                var o = this.serviceProviderProperties.URI.indexOf(
                    "configuration"
                  ),
        ...
        (function (e, t, i) {
        ...
        })(t, [
          {
            ...
            value: function () {
              ...
              if (this.isExternal) {
                var t = this.editorObject.getParam("external_plugins")
                  .tiny_mce_wiris;
